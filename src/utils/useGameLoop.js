 ...
 *   2000+   = Level 3+
 *
 * The LOW platform is always kept above the water surface
 * with a safety margin, so a low platform remains playable.
 */
const PLATFORM_HEIGHT_START_LEVEL = 3;
const SCORE_PER_LEVEL = 1000;
const LOW_PLATFORM_WATER_MARGIN = 20;
const MEDIUM_PLATFORM_OFFSET = 20;
const LOW_PLATFORM_OFFSET = 40;
